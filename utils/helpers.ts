...
export class Helpers {
	...
	public async clickOnElement(element: ElementFinder, timeout: number = 15000): Promise<void> {
		try {
	...
	public async inputText(element: ElementFinder, text: string, timeout: number = 15000): Promise<void> {
		try {
	...
	public async waitTillClickable(element: ElementFinder, timeout: number = 15000): Promise<ElementFinder> {
		try {
	...
	public async waitForElement(element: ElementFinder, timeout: number = 15000): Promise<ElementFinder> {
		try {
